...
addContent("Players", [
  {
    ...
    text: "",
    buttons: [
      { name: "Allspark", url: "../Players/Allspark.html" },       // James
      { name: "Jake Morningstar", url: "../Players/JakeM.html" },  // Ben
      { name: "Mizan My-Zan", url: "../Players/MizanM.html" },     // Quade
      { name: "Kior", url: "../Players/Kior.html" },               // Ronin
      { name: "Marshall", url: "../Players/Marshall.html" },       // Marshall
      { name: "Providence", url: "../Players/Providence.html" },   // Braden
      { name: "Aelaon Somiel", url: "../Players/AelaonS.html" },   // Analee
      // { name: "River", url: "../Players/RiverM.html" },
      // { name: "Shawn", url: "../Players/ShawnT.html" },
      // { name: "Elias", url: "../Players/Elias.html" },
      { name: "\"Multiple character set\"", url: "../Players/MultipleC.html" }, // Elijah
